  ...
  //Serial.println("event");
	uchar c = '0';
  	...
  	SerialPacket.m_Buffer[0] = c;
          ...
          {
            //Serial.println("buffer_correcto");
             tmp = SerialPacket.m_Buffer[1]^SerialPacket.m_Buffer[2]^SerialPacket.m_Buffer[3];
             //Serial.print("tmp: ");
             //Serial.println(tmp);
             //Serial.print("buffer0: ");
             //Serial.println(SerialPacket.m_Buffer[0]);
             //Serial.print("buffer1: ");
             //Serial.println(SerialPacket.m_Buffer[1]);
             //Serial.print("buffer2: ");
             //Serial.println(SerialPacket.m_Buffer[2]);
             //Serial.print("buffer3: ");
             //Serial.println(SerialPacket.m_Buffer[3]);
